...
def add_opendet_config(cfg):
    ...
    # ccl
    _C.CCLOSS =CN()
    _C.CCLOSS.OUT_DIM = 256
    _C.CCLOSS.WEIGHT = 0.1
    _C.CCLOSS.IOU_THR = 0.0
    _C.CCLOSS.INIT = "one-hot"
    _C.CCLOSS.TYPE = "hy"

    # Ual
    _C.UALOSS = CN()
    _C.UALOSS.START_ITER = 100  # usually the same as warmup iter
    _C.UALOSS.EDL_START_ITER = 12800
    _C.UALOSS.LOSS_TYPE = "log"
    _C.UALOSS.TOPK = 3
    _C.UALOSS.WEIGHT = 0.5
    _C.UALOSS.EDL_WEIGHT = 0.1
    _C.UALOSS.LAM = 1.0
